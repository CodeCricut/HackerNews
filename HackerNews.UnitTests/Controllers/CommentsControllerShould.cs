...
namespace HackerNews.UnitTests.Controllers
{
	public class CommentsControllerShould
	{
		...
		public Mock<IEntityHelper<Comment, PostCommentModel, GetCommentModel>> _mockHelper;
		public Mock<IVoteableEntityHelper<Comment>> _mockVoter;
		...
		{
			_mockHelper = new Mock<IEntityHelper<Comment, PostCommentModel, GetCommentModel>>();
			_mockVoter = new Mock<IVoteableEntityHelper<Comment>>();
