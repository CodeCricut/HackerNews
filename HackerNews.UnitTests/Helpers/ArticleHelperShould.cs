...
//			// Act
//			var response = await _articleHelper.PostEntityModelAsync(_postArticleModel, _user);
...
//		{
//			// Act
//			await _articleHelper.PostEntityModelsAsync(_postArticleModels, _user);
...
//			// Act
//			await _articleHelper.SoftDeleteEntityAsync(0, _user);
...
//			// Act
//			await _articleHelper.VoteEntityAsync(0, true, _user);
