namespace HackerNews.CLI.Util
{
	...
	{
		//public static bool IsBoardType(this PostBoard options)
		//{
		//	return !string.IsNullOrEmpty(options.BoardTitle);
		//}

		//public static bool IsArticleType(this PostEntityVerbOptions options)
		//{
		//	return !string.IsNullOrEmpty(options.ArticleTitle);
		//}

		//public static bool IsCommentType(this PostEntityVerbOptions options)
		//{
		//	return !string.IsNullOrEmpty(options.CommentText);
		//}

		//public static bool IsPublicUserType(this PostEntityVerbOptions options)
		//{
		//	// TODO:
		//	return false;
		//}
