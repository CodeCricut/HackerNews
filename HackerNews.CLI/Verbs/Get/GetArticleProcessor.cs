...
{
	public interface IGetArticleProcessor : IGetVerbProcessor<GetArticleModel>
	{

	}

	public class GetArticleProcessor : GetVerbProcessor<GetArticleModel>, IGetArticleProcessor
	{
