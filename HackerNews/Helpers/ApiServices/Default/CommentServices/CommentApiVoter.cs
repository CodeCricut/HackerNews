...
{
	public class CommentApiVoter : IApiVoter<Comment>
	{
		protected readonly IJwtService _jwtService;
		protected HttpClient _client;

		public CommentApiVoter(IHttpClientFactory clientFactory, IOptions<AppSettings> options, IJwtService jwtService)
		{
		...
		public async Task VoteEntityAsync(int entityId, bool upvote)
		{
			...
			var response = await _client.PostAsync($"comments/vote/{entityId}", upvoteJson);
		}
	}
}
